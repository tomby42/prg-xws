/* Ukázka vyplòování eliptických obloukù */
...
static void expose(XExposeEvent *event)
{
    ...
    XSetArcMode(display, my_gc, ArcChord);
    XFillArc(display, topwin, my_gc, 20, 30, 200, 150, 180 * 64, 270 * 64);
    XDrawString(display, topwin, my_gc, 20, 20, "ArcChord", 8);
   
    XSetArcMode(display, my_gc, ArcPieSlice);
    XFillArc(display, topwin, my_gc, 250, 30, 200, 150, 180 * 64, 270 * 64);
    XDrawString(display, topwin, my_gc, 250, 20, "ArcPieSlice", 11);
}

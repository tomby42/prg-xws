...
static void create_resources(int argc, char *argv[])
{
    ...
    Pixmap bgpix; /* Pixmapa pro pozadí */
    XWindowAttributes attr; /* Struktura pro ètení atributù */
    XSetWindowAttributes set_attr; /* Struktura pro zmìnu atributù */
    ...
    /* Vytvoøit synovská okna */
    
    /* 1. okno bude mít okraj vyplnìný barvou a na pozadí stejnou pixmapu jako
     * rodiè, ale zobrazenou od poèátku okna */
    set_attr.background_pixmap = bgpix;
    set_attr.border_pixel = black;
    /* Stisk klávesy nebo tlaèítka my¹i se bude ignorovat a nebude se
     * propagovat do rodièe */
    ...
    /* 2. okno bude mít okraj vyplnìný pixmapou a na pozadí stejnou pixmapu
     * jako rodiè, zobrazenou od poèátku rodièe */
    ...
    /* Stisk klávesy nebo tlaèítka my¹i se bude propagovat do rodièe */
